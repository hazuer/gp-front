                  ...
                  child: Container(
                    ...
                    child: ElevatedButton(
                      ...
                      onPressed: ()async{
                        ...
                        await ListUsersProvider().disabledUser(user.idDatoUsuario!, 2).then((value){
                          if(value == null){
                            setState(() {
                              isLoading = false;
                            });
                            Navigator.pop(context);
                            showInfoDialog(context, "Ocurrió un error al inhabilitar este usuario", "Error: ${RxVariables.errorMessage}");
                          }else{
                            setState(() {
                              isLoading = false;
                            });
                            Navigator.pop(context);
                            showInfoDialog(context, "¡Usuario deshabilitado con exito!", "");
                          }
                        });
                      },
                      style: ElevatedButton.styleFrom(
