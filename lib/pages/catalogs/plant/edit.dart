...
class _PlantEditState extends State<PlantEdit> {
  ...
  void initState() {
    ...
    catPais.idCatPais = RxVariables.gvPlantSelectedById
        .idCatPais; //setear el valor del id del catalogo de pais
    super.initState();
  }
                                          ...
                                          onPressed: () async {
                                            if (plantCtrl.text == "" ||
                                              ...
                                              await PlantsProvider()
                                                  .editPlant(
                                                RxVariables.gvPlantSelectedById
                                                    .idCatPlanta!,
                                                plantCtrl.text.trim(),
                                                catPais.idCatPais!,
                                              )
    ...
    return Container(
      ...
      child: AppExpansionTile(
        ...
        title: Text(
          catPais.nombrePais ??
              RxVariables.gvPlantSelectedById
                  .nombrePais!, //Seteo de titutlo para mostrar
