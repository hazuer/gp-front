...
class _TaraEditState extends State<TaraEdit> {
  ...
  void initState() {
    ...
    catPlanta.idCatPlanta = RxVariables.gvTaraSelectedById.idCatPlanta!;
    super.initState();
  }
                                      ...
                                      children: [
                                        ...
                                        CustomButton(
                                          ...
                                          onPressed: () async {
                                            ...
                                            if (taraEditCtrl.text == "" ||
                                                capacidadEditCtrl.text == "") {
                                              ...
                                              await TarasProvider()
                                                ...
                                                RxVariables.gvTaraSelectedById
                                                    .idCatTara!,
                                                taraEditCtrl.text.trim(),
                                                capacidadEditCtrl.text.trim(),
