...
class OrdenesEntregaRecepcionRecibir extends StatefulWidget {
  @override
  _OrdenesEntregaRecepcionRecibirState createState() =>
      _OrdenesEntregaRecepcionRecibirState();
}

class _OrdenesEntregaRecepcionRecibirState
    extends State<OrdenesEntregaRecepcionRecibir> {
  ...
  Widget build(BuildContext context) {
    ...
    if (currentUser.catProfile!.profileId != 2 &&
      ...
      return AppScaffold(
        pageTitle: 'Orden de fabricación / Ordenes de entrega / Recepción',
