...
Future showInfoDialog(
  ...
  Future dialogChangeStatusMachine(BuildContext context, CatMachineModel alertDialogMachineDisable, String accion, int idCatStatus) async {
                  ...
                  child: Container(
                    ...
                    child: ElevatedButton(
                      ...
                      onPressed: () async {
                        ...
                        await MachinesProvider().changeStatusMachineProvider(alertDialogMachineDisable.idCatMaquina!, idCatStatus).then((value) {
                          ...
                          if (value == null) {
                            ...
                            Navigator.pop(context);
                            showInfoDialog(context, "¡Error!", "Ocurrió un error al $accion la maquina : ${RxVariables.errorMessage}");
                          } else {
