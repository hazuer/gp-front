...
class DesignDialog {
  ...
  Future dialogChangeStatusDesign(
      BuildContext context,
      DesignsList alertDialogDesignDisable,
      String accion,
        ...
        return StatefulBuilder(
          builder: (context, setState) {
            return AlertDialog(
              title: Center(
                  child: Text(
                "¿Desea $accion el diseño: ${alertDialogDesignDisable.nombreDiseno}?",
                textAlign: TextAlign.center,
              )),
              content: isLoading
                  ? Container(
                      ...
                      child: ElevatedButton(
                          ...
                          onPressed: () async {
                            ...
                            await DesignsProvider()
                                .changeStatusDesignProvider(
                                    alertDialogDesignDisable.idCatDiseno!,
                                    idCatStatus)
                                .then((value) {
                              ...
                              if (value == null) {
                                ...
                                showInfoDialog(context, "¡Error!",
                                    "Ocurrió un error al $accion el diseño : ${RxVariables.errorMessage}");
                              } else {
                                final typeAlert =
