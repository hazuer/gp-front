...
class TableListOERecepcion extends StatefulWidget {
  const TableListOERecepcion({Key? key}) : super(key: key);

  @override
  _TableListOERecepcionState createState() => _TableListOERecepcionState();
}

class _TableListOERecepcionState extends State<TableListOERecepcion> {
