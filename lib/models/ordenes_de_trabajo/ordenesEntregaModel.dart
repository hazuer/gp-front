...
OrdenesDeEntregaModel ordenesDeEntregaModelFromJson(String str) =>
    OrdenesDeEntregaModel.fromJson(json.decode(str));

String ordenesDeEntregaModelToJson(OrdenesDeEntregaModel data) =>
    json.encode(data.toJson());

class OrdenesDeEntregaModel {
  OrdenesDeEntregaModel({
    this.result,
  ...
  factory OrdenesDeEntregaModel.fromJson(Map<String, dynamic> json) =>
      OrdenesDeEntregaModel(
        result: json["result"],
