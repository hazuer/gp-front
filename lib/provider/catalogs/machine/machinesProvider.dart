...
class MachinesProvider{
  ...
  Future getAllMachines()async {
    ...
    String url                   = routes.urlBase+routes.listarMachines;
    ...
    try {
      ...
      .replaceAll("}", "")
      .replaceAll("]", "");
      rxVariables.gvBeSubListMachines.sink.addError("Ocurrio un error, intenta más tarde "+RxVariables.errorMessage);
      return  null;
    }
  }
  ...
  Future createMachine (String nombreMaquina, String modelo, int idCatPlanta) async {
  RxVariables.errorMessage = '';
  ...
  Future editMachine(int idCatMaquina, String nombreMaquina, String modelo, int idPlanta) async {
    RxVariables.errorMessage = '';
